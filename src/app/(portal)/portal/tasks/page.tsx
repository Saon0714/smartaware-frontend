  ...
  return (
    <div>
      ...
      {summary && summary.total > 0 && (
        <dl className="mt-6 grid gap-3 sm:grid-cols-3">
          {[
            ...
            <div key={String(label)} className="sa-card rounded-xl border border-border bg-bg p-4 shadow-[var(--sa-shadow-sm)]">
      ...
      <ul className="mt-6 space-y-3">
        {rows.map((task) => (
          <li key={task.id} className="sa-card rounded-xl border border-border bg-bg p-5 shadow-[var(--sa-shadow-sm)]">
