...
const PATHS: Record<string, string> = {
  ...
  inbox: "M3 12h5l1.5 2.5h5L16 12h5M4.5 5h15L21 12v6a1 1 0 01-1 1H4a1 1 0 01-1-1v-6z",
  help: "M12 3a9 9 0 100 18 9 9 0 000-18zM9.6 9.2a2.5 2.5 0 114 2.2c-.9.6-1.6 1.1-1.6 2.1M12 17h.01",
  settings:
    "M12 15.2a3.2 3.2 0 100-6.4 3.2 3.2 0 000 6.4zM19.1 12c0-.4 0-.8-.1-1.2l2-1.5-2-3.4-2.3 1a7.6 7.6 0 00-2-1.2L14.3 3H9.7l-.4 2.7c-.7.3-1.4.7-2 1.2l-2.3-1-2 3.4 2 1.5a7.7 7.7 0 000 2.4l-2 1.5 2 3.4 2.3-1c.6.5 1.3.9 2 1.2l.4 2.7h4.6l.4-2.7c.7-.3 1.4-.7 2-1.2l2.3 1 2-3.4-2-1.5c.1-.4.1-.8.1-1.2z",
