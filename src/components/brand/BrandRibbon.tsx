...
export function BrandRibbon({ className = "" }: { className?: string }) {
  return (
    <div aria-hidden className={`sa-ribbon-band pointer-events-none select-none ${className}`}>
      <svg
